        ...
        static void Main(string[] args)
        {
            ...
            switch(processOption)
            {
                case "order":
                    ...
                    var obj = new OrderRepair();
                    obj.ProcessOrder(productDetail);
                    break;
                case "repair":
                    ...
                    if(productType.Equals("phone"))
                    {
                        Console.WriteLine("Please provide the phone model name");
                        productDetail = Console.ReadLine().Trim();
                        var obj1 = new PhoneRepair();
                        obj1.ProcessPhoneRepair(productDetail);
                    }
                    else
                    {
                        Console.WriteLine("Please provide the accessory detail, like headphone, tempered glass");
                        productDetail = Console.ReadLine().Trim();
                        var obj2 = new AccessoryRepair();
                        obj2.ProcessAccessoryRepair(productDetail);
                    }
                    break;
                default:
                    break;
